...
class SportsmansTable extends \App\BaseTable
{
	...
	public static function getLastItem(): Sportsman
	{
		...
		$sql = 'select sportsmans.id, sportsmans.photo, sportsmans.biography, sportsmans.year, type_sports.id as type_sports_id, type_sports.name as type_sports_name from sportsmans ';
